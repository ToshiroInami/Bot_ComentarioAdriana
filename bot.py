...
POST_ROUND_DELAY_MIN = float(sg("POST_ROUND_DELAY_MIN") or 30.0)
POST_ROUND_DELAY_MAX = float(sg("POST_ROUND_DELAY_MAX") or 40.0)

RESEND_COOLDOWN_SECONDS = int(sg("RESEND_COOLDOWN_SECONDS") or 200)
