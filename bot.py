...
STAGGER_RANDOM_JITTER = float(sg("STAGGER_RANDOM_JITTER") or 20.0)
FORWARD_LAST_N = int(sg("FORWARD_LAST_N") or 3)
FORWARDS_PER_ROUND = int(sg("FORWARDS_PER_ROUND") or FORWARD_LAST_N)
PER_PUB_DELAY_MIN = float(sg("PER_PUB_DELAY_MIN") or 35.0)
...
RESEND_COOLDOWN_SECONDS = int(sg("RESEND_COOLDOWN_SECONDS") or 120)
...
# Replies
WELCOME_DELAY_MIN = float(sg("WELCOME_DELAY_MIN") or 1)
WELCOME_DELAY_MAX = float(sg("WELCOME_DELAY_MAX") or 5)
